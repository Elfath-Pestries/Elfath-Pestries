alert("hiiiiiiiiiiiiiiiiiiiiiiii44444iiii");
odoo.define('home_delivery_odoo_pos_website_mobile_pragtech.HomeDeliveryButton', function(require) {
    ...
    var pos_screens = require('point_of_sale.ProductScreen');
...
//
    alert("hiiiiii2222222222");
    var ShowHomeDeliveryButton = pos_screens.addControlButton({
